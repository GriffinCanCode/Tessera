...
# Integration Test Suite for WikiCrawler R Scripts
...
graph_env <- source_r_script("../r_scripts/graph_analysis.R")
layout_env <- source_r_script("../r_scripts/layout_algorithms.R")
temporal_env <- source_r_script("../r_scripts/temporal_analysis.R")

...
# Quick demo of Tessera capabilities
...
print "=== Tessera Quick Demo ===\n\n";

# Initialize
my $crawler = Tessera->new(config_file => "$FindBin::Bin/../config/crawler.yaml");
...
print "Try: ./bin/tessera --start-title 'Your Interest' --max-articles 10\n";

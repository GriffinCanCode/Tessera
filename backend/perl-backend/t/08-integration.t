...
my $search_results = $tessera->search('computer', 10);
...
my $retrieved_ai = $tessera->get_article('Artificial Intelligence');
...
$tessera->interests(['computer science', 'artificial intelligence']);
is_deeply($tessera->interests, ['computer science', 'artificial intelligence'], 'Interests set for integration test');

# Test knowledge graph building with stored data
my $graph = $tessera->build_knowledge_graph(min_relevance => 0.6);

...
print "\nNext steps:\n";
print "1. Start crawling: perl bin/tessera --start-title 'Your Topic'\n";
print "2. Start API server: perl script/api_server.pl\n";
print "3. View statistics: perl bin/tessera --stats\n";

__END__

=head1 NAME

setup_database.pl - Initialize Tessera database
...
This script initializes the SQLite database for Tessera, creating all

package Tessera::ProjectManager;
...
Tessera::ProjectManager - Project management for Tessera

=head1 SYNOPSIS

    use Tessera::ProjectManager;
    
    my $pm = Tessera::ProjectManager->new(storage => $storage);

...
sub _build_project_manager {
    my $self = shift;
    require Tessera::ProjectManager;
    return Tessera::ProjectManager->new(storage => $self);
}
...
Tessera::Storage - Database storage layer for Tessera

=head1 SYNOPSIS

    use Tessera::Storage;
    
    my $storage = Tessera::Storage->new(

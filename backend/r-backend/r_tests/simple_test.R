...
result <- system(paste("cd .. && Rscript graph_analysis.R", shQuote(graph_json)), intern = TRUE)
...
result <- system(paste("cd .. && Rscript layout_algorithms.R", shQuote(graph_json)), intern = TRUE)
...
result <- system(paste("cd .. && Rscript temporal_analysis.R", shQuote(temporal_json)), intern = TRUE)

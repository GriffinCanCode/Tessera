...
nohup python data_ingestion_service.py > data_ingestion_service.log 2>&1 &
INGESTION_PID=$!
...
echo "   • Data Ingestion Service: YouTube, Books, Articles, Poetry Processing"
echo "   • Background Processing: Auto-embedding new article chunks"
echo "   • Unified Database: Single SQLite DB for all data"
echo ""
echo -e "${BLUE}🔧 Next Steps:${NC}"
echo "   1. Start the main Perl API server: cd ../perl-backend/script && perl api_server.pl"

package WikiCrawler::HashManager;
...
WikiCrawler::HashManager - Centralized hashing strategy manager for WikiCrawler

=head1 SYNOPSIS

    use WikiCrawler::HashManager;
    
    my $hasher = WikiCrawler::HashManager->new();
...
WikiCrawler::HashManager provides a centralized, optimized hashing strategy for
different use cases within the WikiCrawler system. It automatically selects the
